# -*- coding: utf-8 -*-
"""
Created on Thu Mar 29 19:24:56 2018
...
cwd = os.getcwd()
#path='C:\\Users\\barna\\Documents\\images3/*g'
path=cwd+'/images3/*g'
print(path)
...
saver = tf.train.import_meta_graph('E:\\DepthMapAnalysis\\cnn_depth_tensorflow-master\\cnn_depth_tensorflow-master\\refine\\model.ckpt-1630.meta')
saver.restore(sess,'E:\\DepthMapAnalysis\\cnn_depth_tensorflow-master\\cnn_depth_tensorflow-master\\refine\\model.ckpt-1630')
saver1 = tf.train.import_meta_graph('E:\\DepthMapAnalysis\\cnn_depth_tensorflow-master\\cnn_depth_tensorflow-master\\coarse\\model.ckpt-1630.meta')
saver1.restore(sess1,'E:\\DepthMapAnalysis\\cnn_depth_tensorflow-master\\cnn_depth_tensorflow-master\\coarse\\model.ckpt-1630')
...
#print(sess1.run(coarse7_output))
#coarse7_output=tf.reshape(coarse7_output,[1,55,74,1])
...
fconv4=tf.nn.conv2d(fine3_dropout,fval6,[1, 1, 1, 1],padding='SAME')
